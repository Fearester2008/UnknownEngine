...
{
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('Modi_Checker'),0.2,0.2,XY, true, true);
	...
	public function new(?goToPlayState:Bool)
	{
		...
		ModifiersState.goToPlayState = goToPlayState;
		
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('modiBG_Main'));
		bg.screenCenter();
